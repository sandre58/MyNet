...
/// </summary>
public interface IFilterViewModel : INotifyPropertyChanged, ICloneable, ISettable, ISimilar<IFilterViewModel>
{
    /// <summary>
    /// Gets the target property name used by this filter.
    /// </summary>
    string PropertyName { get; }

    /// <summary>
    /// Determines whether the specified object matches this filter.
    /// </summary>
    /// <param name="target">The object to evaluate.</param>
    /// <returns>True if the object matches; otherwise, false.</returns>
