...
public class StringListEditionViewModel : ViewModelBase
{
    ...
    {
        AddCommand = RelayCommandFactory.Default.CreateRequired<StringWrapper>(_ => Add(), CanAdd);
        RemoveCommand = RelayCommandFactory.Default.CreateRequired<StringWrapper>(Remove, CanRemove);
