    ...
    IComparable<FluentTimeSpan>
{
    ...
    /// <summary>
    /// Subtracts a <see cref="FluentTimeSpan"/> from a <see cref="TimeSpan"/> by negating the months and years components and subtracting the TimeSpan components.
    /// </summary>
    /// <param name="left">The TimeSpan from which to subtract.</param>
    /// <param name="right">The FluentTimeSpan to subtract.</param>
    /// <returns>A new FluentTimeSpan representing the result of the subtraction.</returns>
    ...
    /// <summary>
    /// Adds a <see cref="TimeSpan"/> to a <see cref="FluentTimeSpan"/> by adding the TimeSpan components and keeping the months and years components unchanged.
    /// </summary>
    /// <param name="left">The FluentTimeSpan to which to add.</param>
    /// <param name="right">The TimeSpan to add.</param>
    /// <returns>A new FluentTimeSpan representing the result of the addition.</returns>
    private static FluentTimeSpan AddInternal(FluentTimeSpan left, TimeSpan right) => left with { TimeSpan = left.TimeSpan + right };

    /// <summary>
    /// Adds two <see cref="FluentTimeSpan"/> instances by adding their months, years, and TimeSpan components together.
    /// </summary>
    /// <param name="left">The first FluentTimeSpan to add.</param>
    /// <param name="right">The second FluentTimeSpan to add.</param>
    /// <returns>A new FluentTimeSpan representing the result of the addition.</returns>
    ...
    /// <summary>
    /// Subtracts a <see cref="TimeSpan"/> from a <see cref="FluentTimeSpan"/> by subtracting the TimeSpan components and keeping the months and years components unchanged.
    /// </summary>
    /// <param name="left">The FluentTimeSpan from which to subtract.</param>
    /// <param name="right">The TimeSpan to subtract.</param>
    /// <returns>A new FluentTimeSpan representing the result of the subtraction.</returns>
    private static FluentTimeSpan SubtractInternal(FluentTimeSpan left, TimeSpan right) => left with { TimeSpan = left.TimeSpan - right };

    /// <summary>
    /// Subtracts two <see cref="FluentTimeSpan"/> instances by subtracting their months, years, and TimeSpan components.
    /// </summary>
    /// <param name="left">The first FluentTimeSpan to subtract.</param>
    /// <param name="right">The second FluentTimeSpan to subtract.</param>
    /// <returns>A new FluentTimeSpan representing the result of the subtraction.</returns>
