...
public class TruncatorExtensionsTests
{
    ...
    [InlineData("Text with delimiter length greater than truncate length truncates to fixed length without truncation string", 2, "...", "Te")]
    [InlineData("Null truncation string? truncates to truncate length without truncation string", 4, null, "Null")]
    public void TruncateWithTruncationStringAndFixedLengthTruncator(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty()));
    ...
    public void TruncateWithTruncationStringAndFixedNumberOfCharactersTruncator(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.TruncateCharacters(length, truncationString.OrEmpty()));
    ...
    public void TruncateWithTruncationStringAndFixedNumberOfWordsTruncator(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.TruncateWords(length, truncationString.OrEmpty()));
    ...
    public void TruncateWithTruncationStringAndFixedLengthTruncatorTruncateFromLeft(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty(), direction: TruncateFrom.Left));
    ...
    [InlineData("Null truncation string? truncates to truncate length without truncation string", 4, null, "ring")]
    public void TruncateWithTruncationStringAndFixedNumberOfCharactersTruncatorTruncateFromLeft(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.TruncateCharacters(length, truncationString.OrEmpty(), direction: TruncateFrom.Left));
    ...
    [InlineData("Text with whitespace at the end  ", 4, "...", "...whitespace at the end")]
    public void TruncateWithTruncationStringAndFixedNumberOfWordsTruncatorTruncateFromLeft(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.TruncateWords(length, truncationString.OrEmpty(), direction: TruncateFrom.Left));
}
