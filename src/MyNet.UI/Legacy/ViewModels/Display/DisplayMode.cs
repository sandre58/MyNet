// -----------------------------------------------------------------------
// <copyright file="DisplayMode.cs" company="St�phane ANDRE">
...
public class DisplayMode : StringTranslatable, IDisplayMode
{
    ...
    public DisplayMode(string key)
        : base(key) => ResetCommand = RelayCommandFactory.Default.Create(Reset);
...
public class DisplayModeList : DisplayMode
{
        ...
        : base(nameof(DisplayModeList))
    {
        ...
        SetDisplayedColumnsCommand = RelayCommandFactory.Default.CreateRequired<IEnumerable<string>>(ColumnLayouts.SetDisplayedColumns);
    }
...
public class DisplayModeCalendar : DisplayMode
{
        ...
        : base(key)
    {
        ...
        MoveToPreviousDateCommand = RelayCommandFactory.Default.Create(MoveToPreviousDate);
        MoveToNextDateCommand = RelayCommandFactory.Default.Create(MoveToNextDate);
        MoveToTodayCommand = RelayCommandFactory.Default.Create(MoveToToday);
    }
