// -----------------------------------------------------------------------
// <copyright file="ImportBySourcesDialogViewModel.cs" company="St�phane ANDRE">
    ...
    where T : ImportableViewModel
{
    ...
    private ImportBySourcesDialogViewModel(ItemsBySourceProvider<T> itemsProvider,
        ...
        SelectionMode selectionMode = SelectionMode.Multiple,
        string? title = null)
        : base(itemsProvider, new(itemsProvider, listParametersProvider, selectionMode), title) { }
}
