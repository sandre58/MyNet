...
throw new ArgumentException(
    "The metadata type must implement IMetadataProvider.",
    nameof(type));
```
...
Prefer explicit loops when performance matters.
...
Breaking changes should be minimized and intentional.

Prefer additive evolution over redesign when possible.
