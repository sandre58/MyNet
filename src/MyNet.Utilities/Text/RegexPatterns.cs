// -----------------------------------------------------------------------
// <copyright file="RegexPatterns.cs" company="Stéphane ANDRE">
...
/// <summary>
/// Provides common regex patterns for text validation and matching.
/// </summary>
public static partial class RegexPatterns
{
    /// <summary>
    /// Gets a precompiled regex pattern for validating email addresses.
    /// Matches email addresses with a local part, "@" symbol, and domain part.
    /// </summary>
    public static Regex EmailPattern { get; } = GetEmailRegex();

    /// <summary>
    /// Gets a precompiled regex pattern for validating phone numbers.
    /// Matches phone numbers with optional country code, area code, and extension.
    /// </summary>
    public static Regex PhonePattern { get; } = GetPhoneRegex();
