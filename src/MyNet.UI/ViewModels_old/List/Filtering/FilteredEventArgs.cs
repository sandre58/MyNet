...
/// </summary>
/// <param name="filters">The collection of filters that were applied.</param>
public class FilteredEventArgs(IEnumerable<IFilter<object>> filters) : EventArgs
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<IFilter<object>> Filters { get; } = filters;
}
