// -----------------------------------------------------------------------
// <copyright file="FileExportByColumnsViewModelBase.cs" company="St�phane ANDRE">
    ...
    where TColumnMapping : StringTranslatable
{
        ...
        : base(fileExtensionInfo, defaultExportName, defaultFolder)
    {
        ...
        SetSelectedColumnsCommand = RelayCommandFactory.Default.CreateRequired<ICollection<string>>(SetSelectedColumns);
