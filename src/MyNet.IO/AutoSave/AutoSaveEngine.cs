...
public abstract partial class AutoSaveEngine(TimeSpan interval, ILogger? logger = null) : IAutoSaveEngine, IDisposable
{
    private readonly ILogger _logger = logger ?? NullLogger<AutoSaveEngine>.Instance;
    ...
    [LoggerMessage(LogLevel.Error, "Auto-save loop failed.")]
    partial void LogAutoSaveLoopFailed(Exception exception);
}
